...
class EventDetails extends Component {
    ...
    userJoinEvent() {
        ...
        this.props.userJoin(this.state.info).then(function(response){
            ...
            } else if (response.payload.data.success === true && this.state.coordinates !== "null") {
        ...
        return (
            <div className="col-sm-12 col-xs-12 singleItem">
                ...
                <div className="col-sm-12 buttonContainer">
                    ...
                    <button onClick={this.userJoinEvent} className="col-sm-4 col-sm-offset-1 col-xs-6 btn btn-success" type="button">Join Event</button>
                </div>
