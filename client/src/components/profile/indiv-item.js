...
class EventDetails extends Component {
    constructor (props) {
        ...
        this.userDeleteEvent = this.userDeleteEvent.bind(this);
    ...
    userDeleteEvent() {
        ...
        const id = 185
        this.props.deletEvent(id).then(() => {
            console.log('event at: ' + id + ' has been deleted');
        });
    }
        ...
        return (
            <div className="col-sm-12 col-xs-12 singleItem">
                ...
                <div className="col-sm-12 buttonContainer">
                    ...
                    <button onClick={this.userDeleteEvent} className="col-sm-4 col-sm-offset-3 btn btn-danger infoButton" type="button">Delete Event</button>
                </div>
